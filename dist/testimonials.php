...
<section>
    ...
    <div class="min-w-screen min-h-screen bg-gray-50 flex items-center justify-center">
        <div class="w-full bg-white px-5 py-10 md:py-16 text-gray-900">
            <div class="w-full max-w-6xl mx-auto">
                <div class="text-center max-w-xl mx-auto">
                    <h1 class="text-6xl md:text-7xl font-bold mb-5 text-gray-800">What people <br>are saying.</h1>
                    <h3 class="text-xl mb-5 ">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h3>
                </div>
                <div class="-mx-3 md:flex items-start">
                    <div class="px-3 md:w-1/3">
                        <div class="w-full mx-auto rounded-lg bg-white border border-gray-200 p-5 text-gray-800  mb-6 hover:shadow-2xl mb-2 h-auto rounded-md cursor-pointer transition ease-in-out delay-150  hover:-translate-y-1 hover:scale-110 duration-300">
                            <div class="w-full flex mb-4 items-center">
                                <div class="overflow-hidden rounded-full w-10 h-10 bg-gray-50 border border-gray-200">
                                    <img src="../img/profile-user-img.png" alt="">
                                </div>
